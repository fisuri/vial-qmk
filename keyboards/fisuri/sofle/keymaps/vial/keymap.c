...
//╷         ╷         ╷         ╷         ╷         ╷         ╷         ╷╷         ╷         ╷         ╷         ╷         ╷         ╷         ╷
   ...
   KC_LCTL,  KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_MUTE,    KC_MUTE, KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,  KC_BSLS,
                       KC_LCTL,  KC_LALT,  KC_LGUI,  MO(1),    KC_SPC,     KC_ENT,  MO(2),    KC_BSPC,  KC_DEL,   KC_LCAP
),
[1] = LAYOUT(
//╷         ╷         ╷         ╷         ╷         ╷         ╷         ╷╷         ╷         ╷         ╷         ╷         ╷         ╷         ╷
   XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,                       XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  KC_MINS,  XXXXXXX,
   XXXXXXX,  KC_PGUP,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,                       KC_EQL,   KC_7,     KC_8,     KC_9,     KC_PLUS,  XXXXXXX,
   _______,  KC_PGDN,  KC_HOME,  KC_END,   KC_INS,   KC_PSCR,                       KC_0,     KC_4,     KC_5,     KC_6,     KC_SLSH,  XXXXXXX,
